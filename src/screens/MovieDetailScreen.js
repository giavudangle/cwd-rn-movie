...
const MovieDetailScreen = (props) => {
  ...
  const getYoutubeKey = (movieId) => {
    fetch(`${API_CONFIG.BASE_URL}/movie/${movieId}/videos?api_key=${API_CONFIG.API_KEY}`)
    .then((res) => res.json())
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Image style={styles.poster} source={{uri:`${API_CDN_CONFIG.CDN_URL_W500}${movie.backdrop_path}`}} />
      </View>
